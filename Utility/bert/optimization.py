...
def create_dp_optimizer(loss, init_lr, num_train_steps, num_warmup_steps, ledger):
...
def create_optimizer(loss, init_lr, num_train_steps, num_warmup_steps, use_tpu, rho=None):
